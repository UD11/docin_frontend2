      ...
      <div className="w-full max-w-screen-xl p-8">
        <div className="relative my-4">
          ...
          {searchResults.map((result, index) => (
            <div
              className="border border-[#d1e0db] p-4 rounded-lg bg-[#ebf4f1] shadow-md relative my-4 shadow-cyan-500/50 cursor-pointer transition-transform transform-gpu hover:scale-105 hover:shadow-green-800"
              key={index}
