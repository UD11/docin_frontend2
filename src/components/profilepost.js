...
const Card = ({ title, description, author, institution, link, id }) => {
  ...
  return (
    <div
      className="relative w-80 p-6 mt-24  rounded-lg mx-4 bg-white mb-4 shadow-cyan-500/50 shadow-xl hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/100"
      // onClick={() => navigateToPdf(id)}
    >
